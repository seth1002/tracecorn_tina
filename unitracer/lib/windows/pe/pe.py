...
class PE(object):
    def __init__(self, fname):
        try:
            ...
            print(str(e))
            raise Exception('Open PE file:{} failed!'.format(fname))

        self.fname = fname
        self.fp = fp
        self.dll_ord_exp_name = {}
    ...
    def parse(self):
        ...
        for section_header in section_headers:
            ...
            data = fp.read(section_header.SizeOfRawData)
    ...
    def map_data(self):
        ...
        size = max(map(lambda x:x.VirtualAddress+x.Misc.VirtualSize, section_headers))
        ...
        for sh in section_headers:
            ...
            # mapped.write(fp.read(sh.SizeOfRawData))
            mapped.write(sh.data)
    ...
    def parse_export_directory(self):
        ...
        for i in range(len(names)):
            ...
            exports[names[i]] = funcs[ordinals[i]]
            self.dll_ord_exp_name[ordinals[i]+export_dir.Base] = names[i]
    ...
    def parse_import_directory(self):
        ...
        while True:
            ...
            if import_dir.Characteristics == 0 and import_dir.FirstThunk == 0:
                break
        ...
        for import_dir in import_dirs:
            ...
            if import_dir.OriginalFirstThunk == 0:
            ...
            while True:
                ...
                load_cdata(thunk_data.u1.AddressOfData, import_by_name, isrva=True, check=False)
            ...
            while True:
                ...
                if len(original_first_thunks[idx]) > 1:
                    ...
                    imports[dllname][original_first_thunks[idx][0]] = vaddr
                    # continue
                idx += 1
